...
* [`java.util.function.IntFunction` Interface Documentation](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/IntFunction.html)
...
1. Take a close look at the `copyOf` method and its associated Javadoc in `MoreLambdaFun.java`. 
   ...
   1. In order to call this method, we need a reference to an object of a class that implements 
     ...
     [`IntFunction<R>`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/function/IntFunction.html). 
